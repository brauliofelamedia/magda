                    ...
                    <div class="box-inner">
                        <div class="row">
                            <div class="col-xl-12 text-center">
                                <h2 class="text-center" style="font-weight: bold;">¡Gracias por contestar!</h2>
                                <p class="text-center" style="margin:10px 0;">¡Gracias por completar la evaluación! Valoramos tus respuestas y tu tiempo.</p>
                                <a href="{{route('dashboard.welcome')}}" class="btn btn-success" style="margin-top:20px;display: inline-block;">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
