                    ...
                    <div class="col-lg-8 offset-2">
                        ...
                        <div class="step-app" id="steps">
                            @php
                                ...
                                $count = 1;
                            @endphp
                            <span id="step-active"></span>/{{count($assesment['interests']['groups'][0]['items'])}}
                            <ul class="step-steps" style="display: none;">
                                @foreach($assesment['interests']['groups'][0]['items'] as $asses)
                            ...
                            <div class="step-content">
                                <form action="#">
                                    @foreach($assesment['interests']['groups'][0]['items'] as $key => $asses)
                                        <div class="step-tab-panel" data-step="step{{$asses['id']}}">

                                            <h4 class="text-center">{{$assesment['interests']['groups'][0]['items'][$key]['text']}}</h4><br>

                                            @foreach($assesment['interests']['groups'][0]['items'][$key]['answers'] as $key => $answer)
...
<script>
    ...
    $('.answer').on('click', function() {
        ...
        responses[newKey] = parseInt(getLatestDigit(answerId));
    ...
    var steps = $('#steps').steps({
        ...
        onFinish: function () {
            Swal.fire({
                title: '¡Atención!',
                text: 'Se está guardando tu evaluación. Por favor, espera.',
                icon: 'info',
