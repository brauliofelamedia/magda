                                    ...
                                    <div class="step">
                                        ...
                                        @for($a=0;$a<count($assesment['interests']['groups'][0]['items'][$i]['answers']);$a++)
                                            <div class="form-check ps-0 q-box">
                                                <input class="form-check-input question__input" type="radio" name="radio{{$assesment['interests']['groups'][0]['items'][$i]['id']}}" id="{{$assesment['interests']['groups'][0]['items'][$i]['answers'][$a]['id']}}">
